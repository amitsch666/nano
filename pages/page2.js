    ...
    return (
      <div className="masterdiv">
        ...
        <main className="container-fluid px-0">
          <NanoButton type="button" className="btn btn-lg btn-success btn-nano" onClick={() => Router.push('/about')}>About</NanoButton>
          <Link prefetch href="/about"><a>About Page</a></Link>
          <hr />
          {this.props.user ? (<p>{this.props.user.firstName}</p>) : (<p>not logged in</p>) }
          <hr />
          <NanoButton type="button" className="btn btn-lg btn-danger btn-nano" onClick={this.toggleModal1}>Open modal</NanoButton>
